...
<?php
  ...
  switch ($set) {
    case 1:  $k = 25; $mirror = true;  break;
    case 2:  $k = 75; $mirror = false; break;
    default: $k = 75; $mirror = true;  break;
  }
  $str = '';
  for ($i = 0; $i < ((750/$k)/2); $i++) {
...
$svg .= sprintf('<rect class="cs1" x="%s" y="%s" width="%s" height="%s" rx="%s" stroke-width="%s" />' . PHP_EOL, 
